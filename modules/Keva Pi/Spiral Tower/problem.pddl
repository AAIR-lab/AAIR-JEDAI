...
(:goal (and
    ...
    (sideways plank_iii) 
    (onDoublePlank plank_iv plank_i plank_ii)
    (sideways plank_iv) 
    (onDoublePlank plank_v plank_iii plank_iv)
    (sideways plank_v) 
    (onDoublePlank plank_vi plank_iii plank_iv)
    (sideways plank_vi) 
    (onDoublePlank plank_vii plank_v plank_vi)
    (sideways plank_vii) 
    (onDoublePlank plank_viii plank_v plank_vi)
    (sideways plank_viii) 
)))
