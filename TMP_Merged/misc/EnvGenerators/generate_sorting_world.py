...
def execute(num_objects, cylinder_dims=(0.05, 0.2), max_radial_distance=0.73, robot_dist_from_table=0.05,
            seed=int(time.time()), envFile='generated_env.dae', tabletype='rll', viewer=False):
...
if __name__ == "__main__":
    create_env(3, (0.03, 0.2), viewer=True)
