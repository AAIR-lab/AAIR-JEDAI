(define (problem p01)
	...
	(:objects 
		...
		gripper - manip
		object1 object2 object3 object4 object5 object6 object7 object8 object9 object0 - object
		obj_loc1 obj_loc2 obj_loc3 obj_loc4 obj_loc5 obj_loc6 obj_loc7 - location 
		obj_loc8 obj_loc9 obj_loc0 - location
		table - location
		gp_ob1 gp_ob2 gp_ob3 gp_ob4 gp_ob5 gp_ob6 gp_ob7 gp_ob8 gp_ob9 gp_ob0 - pose
		pd_ob1 pd_ob2 pd_ob3 pd_ob4 pd_ob5 pd_ob6 pd_ob7 pd_ob8 pd_ob9 pd_ob0 - pose
		traj - trajectory
		obj_tloc1 obj_tloc2 obj_tloc3 obj_tloc4 obj_tloc5 obj_tloc6 obj_tloc7 obj_tloc8 - location
		obj_tloc9 obj_tloc0 - location
		defaultloc - location
		initpose - pose
		initloc - location
