...
class DeltaMotionPlanGeneratorPRPY(Generator):
    def __init__(self, ll_state=None, known_argument_values=None):
        required_values = ['pose_current', 'pose_end']
        super(DeltaMotionPlanGeneratorPRPY, self).__init__(known_argument_values, required_values)
    ...
    def get_traj_from_planner(self):
        try:
            ...
            print(__file__.split('/')[-1],": Could not find delta motion plan")
            return None
