...
class PostGraspPoseGeneratorKeva(Generator):
    ...
    def _compute_pose_list(self):
        post_grasp_offset = 0.03
        # post grasp pose is always offset in z axis in world frame
        world_T_gripper_new = self.grasp_pose.copy()
        world_T_gripper_new[2][3] += post_grasp_offset
        pose_list = []
