...
class OpenRavePlannerV2():

    def __init__(self, motion_planner=Config.OPENRAVE_NATIVE_MOTION_PLANNER):
        # super(OpenRavePlannerV2,self).__init__()
        self.motion_planner = getattr(OpenRaveMotionPlanner, motion_planner)

    # def apply(self, current_ll_state, generated_values):
    #     env, robot = current_ll_state.get_env_and_robot()
